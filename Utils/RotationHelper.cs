...
namespace RCPA.Utils
{
  public class RotationHelper
  {
    ...
    public RotationHelper(byte[,] source, byte backGroundColor)
    {
      this.source = source;
    ...
    public byte[,] Rotate(float angle)
    {
      ...
      Point p2 = new Point(nWidth, 0);
      Point p3 = new Point(0, nHeight);
      Point p4 = new Point(nWidth, nHeight);
